...
used in 2011 by García Arenas et al in
...
In a first study \cite{LNCS86720702}, we proved that in effect our
...
The main objective of this paper was to prove the efficiency of randomized pool-based evolutionary algorithms in a wide range of benchmarks, from a simple OneMax Problem to more complicated, and common, floating-point benchmars, which are also evaluated in a wide range of problem sizes.
Using the RPW approach, it seems that a PEA can be executed successfully
