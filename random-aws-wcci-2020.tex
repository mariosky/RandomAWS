...
library \cite{fortin2012deap} using the following parameters: For OneMac, two-point crossover,
...
this EA returns the result to the pool. The experimental platform used in this work is
