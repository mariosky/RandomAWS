...
this paper we present a method inspired by a work of 
...
%Why Parallel
Biological evolution is a process with intrinsical properties that we can find
in some computational systems, that are asynchronous, parallel, and distributed;
...
In the study presented here, a method called Randomized Parameter
